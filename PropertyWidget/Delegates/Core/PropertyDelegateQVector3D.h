...
#ifndef PROPERTY_DELEGATE_QVECTOR3D_H
#define PROPERTY_DELEGATE_QVECTOR3D_H

#include "../Utils/PropertyDelegateMisc.h"

class QtnPropertyQVector3DBase;

class QTN_PW_EXPORT QtnPropertyDelegateQVector3D: public QtnPropertyDelegateTypedEx<QtnPropertyQVector3DBase>
{
...
#endif // PROPERTY_DELEGATE_QVECTOR3D_H
